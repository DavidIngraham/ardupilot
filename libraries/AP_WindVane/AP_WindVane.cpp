...
const AP_Param::GroupInfo AP_WindVane::var_info[] = {
    ...
    // @Values: 0:None,1:Heading when armed,2:RC input offset heading when armed,3:Analog,4:NMEA,10:SITL true,11:SITL apparent, 20:Angle Sensor 1, 21: Angle Sensor 2
    // @User: Standard
    // @RebootRequired: True

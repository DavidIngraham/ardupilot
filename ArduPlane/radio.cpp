...
void Plane::set_control_channels(void)
{
    ...
    if (aparm.throttle_min >= 0) {
        ...
        SRV_Channels::set_range(SRV_Channel::k_throttle_reverse_flag, 100);
        SRV_Channels::set_range(SRV_Channel::k_throttleLeft_reverse_flag, 100);
        SRV_Channels::set_range(SRV_Channel::k_throttleRight_reverse_flag, 100);
    }
